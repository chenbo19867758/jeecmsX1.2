...
/**
 * 用户没有该站点访问权限错误信息类，用于支持用户没有该站点访问权限的处理。
 * @author: tom
 * @date:   2019年4月4日 上午9:10:24
 * @Copyright:  江西金磊科技发展有限公司  All rights reserved.Notice 仅限于授权后使用，禁止非授权传阅以及私自用于商业目的。
 */
public class CrossSiteDataExceptionInfo implements ExceptionInfo {
	 ...
	 *           跨站点数据错误的响应数据。
	 */
	public CrossSiteDataExceptionInfo(String defaultMessage, Object data) {
		this.defaultMessage = defaultMessage;
		this.data = data;
	}
	
	public CrossSiteDataExceptionInfo() {
	}
