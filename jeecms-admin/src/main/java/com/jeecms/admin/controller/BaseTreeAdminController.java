 ...
 * 
 * @author: ljw
 * @date: 2019年4月30日 下午2:28:17
 */
public class BaseTreeAdminController<T extends AbstractTreeDomain<T, ID>, ID extends Serializable>
		extends BaseAdminController<T, ID> {
	...
	public JSONArray getChildTree(Collection<T> childs, boolean lazyType, 
		...
		for (T t : childs) {
			...
			for (String field : fieldNames) {
				jsonObject.put(field, ReflectUtils.invokeGetter(t, field));
			}
