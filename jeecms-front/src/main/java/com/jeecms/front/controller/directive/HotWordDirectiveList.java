 ...
 * @author xiaohui
 * @version 1.0
 * @date 2019/7/16 15:08
 */

public class HotWordDirectiveList implements TemplateDirectiveModel {
	/**
	 * 模板名称
	 */
	public static final String TPL_NAME = "cms_hot_word_list";
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		List<SysHotWord> hotWords = hotWordService.getList(map, paginable, true);
		Map<String, TemplateModel> paramWrap = new HashMap<String, TemplateModel>(params);
		paramWrap.put(OUT_LIST, DefaultObjectWrapperBuilderFactory.getDefaultObjectWrapper().wrap(hotWords));
