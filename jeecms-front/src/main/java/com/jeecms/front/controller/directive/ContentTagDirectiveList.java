...
public class ContentTagDirectiveList implements TemplateDirectiveModel {
	/**
	 * 模板名称
	 */
	public static final String TPL_NAME = "cms_tag_list";
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		Paginable paginable = new PaginableRequest(1, count);
		List<ContentTag> contentTags = tagService.getList(map, paginable, true);
		Map<String, TemplateModel> paramWrap = new HashMap<String, TemplateModel>(params);
		paramWrap.put(OUT_LIST, DefaultObjectWrapperBuilderFactory.getDefaultObjectWrapper().wrap(contentTags));
